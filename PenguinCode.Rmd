...
Two sets of linear regression between are carried out, one for the entire penguins dataset
...
plot_scatter_lm(culmen_data, culmen_length_mm, culmen_depth_mm, "Adelie",,,"Culmen Length (mm)", "Culmen Depth (mm)", species, species_colours)
